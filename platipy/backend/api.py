...
class DicomLocationEndpoint(Resource):
    ...
    parser.add_argument(
        "name", required=True, help="Name to identify this Dicom location"
    )
    parser.add_argument(
        "host", required=True, help="Dicom location host name or IP address"
    )
    parser.add_argument(
        "port", type=int, required=True, help="The port of the Dicom location"
    )
...
class DataObjectEndpoint(Resource):
    ...
    parser = reqparse.RequestParser()
    parser.add_argument(
        "dataset", required=True, help="Dataset ID to add Data Object to"
    )
    parser.add_argument(
        "type",
        choices=("DICOM", "FILE"),
...
class DatasetEndpoint(Resource):
    ...
    parser.add_argument(
        "to_dicom_location", help="ID of DicomLocation the send output data to"
    )
...
class TriggerEndpoint(Resource):
    ...
    parser = reqparse.RequestParser()
    parser.add_argument(
        "algorithm", required=True, help="The name of the algorithm to trigger"
    )
    parser.add_argument(
