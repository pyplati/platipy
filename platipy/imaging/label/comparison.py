...
def compute_metric_total_apl(label_ref, label_test, distance_threshold_mm=0):
    ...
    total_added_path_length = np.sum(added_path_length_list)
    total_added_path_length_mm = total_added_path_length * np.mean(label_ref.GetSpacing()[:2])
...
def compute_metric_mean_apl(label_ref, label_test, distance_threshold_mm=0):
    ...
    mean_added_path_length = np.mean(added_path_length_list)
